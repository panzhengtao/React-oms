...
router.get('/menuData', (req, res) => {
    ...
    res.json({
        code: '0', data: {
            topmenudata: [
                {key: '1', name: '首页', url: '/'},
                {key: '2', name: '订单管理', url: '/orderconfig/'},
                {key: '3', name: '系统配置', url: '/systemconfig/'}],
            leftmenudata: [
                {
                    son: [{key: '11', name: '速卖通订单列表', url: '/smtorderlist/'}, {key: '12', name: '订单导入', url: '/'}],
                    name: '平台订单',
                    key: '1',
                    parent: '/orderconfig/'
                },
                {
                    son: [{key: '21', name: '订单列表', url: '/orderlist/'}, {key: '22', name: '异常订单', url: '/exceptionorderlist/'}],
                    name: '订单管理',
                    key: '2',
                    parent: '/orderconfig/'
                },
                {
                    son: [{key: '31', name: '分仓包裹', url: '/deliveryparcellist/'}, {key: '32', name: '负利润审核', url: '/negativeprofitauditlist/'}],
                    name: '发货包裹',
                    key: '3',
                    parent: '/orderconfig/'
                },
                {
                    son: [{key: '41', name: '抓单转换配置', url: '/conversion/'}, {key: '42', name: '渠道标记配置', url: '/channellist/'},
                        {key: '43', name: '标记状态配置', url: '/signlist/'},{key: '44', name: '指定仓发货规则配置', url: '/warehouselist/'}],
                    name: '订单配置',
                    key: '4',
                    parent: '/orderconfig/'
                }
