    ...
    render() {
        const menu = (
            <Menu>
                <Menu.Item key='updatepwd'>
                    <a href="javascript:;" onClick={this.preUpdatePwd}>修改密码</a>
                </Menu.Item>
                <Menu.Item key='loginout'>
                    <a href="http://admin.admin.com/login/index.html">退出</a>
                </Menu.Item>
            </Menu>
        );
        ...
        return (
            <div className="topwidget">
                <div className="toplf">
                    <div className="icft20 " onClick={ this.props.onTransform}><Icon title="收缩" type="menu-fold" className="anticon anticon-menu-fold"
                                                   /></div>
                ...
                <div className="topgt">
                    ...
                    <div className="crm-flrt pd-r20 top_user">
                        <img src={require('./img/user.png')} height="40" width="40"/>
                    </div>
