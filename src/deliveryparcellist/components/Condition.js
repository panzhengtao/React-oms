                    ...
                    <div className="content">
                        ...
                        <Row style={{'padding': '8px 0px'}}>
                           ...
                           <Col span={6}>
                             ...
                             <Col span={6}>
                                    <FormItem {...this.formItemLayout2}
                                              label="分仓订单状态" style={{"width": "100%", paddingRight: '10px'}}
                                    >
                            ...
                            <Col span={6}>
                                    <FormItem {...this.formItemLayout2}
                                              label="发货仓库" style={{"width": "100%", paddingRight: '10px'}}
                                    >
                        ...
                        <Row style={{'padding': '8px 0px'}}>
                            ...
                            <Col span={6}>
                                <FormItem  {...this.formItemLayout}
                                           label="物流追踪码" style={{"width": "100%", paddingRight: '10px'}}
                                >
                            ...
                            <Col span={6}>
                                    <FormItem {...this.formItemLayout2}
                                              label="是否负利润" style={{"width": "100%", paddingRight: '10px'}}
                                    >
